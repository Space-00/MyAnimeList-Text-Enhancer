...
2. **نصب MyAnimeList Text Enhancer**:
   ...
   - [code]([https://www.tampermonkey.net/](https://raw.githubusercontent.com/Space-00/MyAnimeList-Text-Enhancer/main/MyAnimeList%20Text%20Enhancer.js)) رو کلیک کنین و کد رو کپی کنین
